...
componentDidMount() {  
   axios({
     ...
     url : "http://localhost:3001/workshop"
   }).then((d)=>{
     console.log("data for workshop from backend");
     console.log(d.data);
     console.log(d.data[0].numOfWorkshop);
     console.log(d.data[0].numOfLecturesAndSeminars);
     this.setState({max_workshop : d.data[0].numOfWorkshop,
      max_lec : d.data[0].numOfLecturesAndSeminars})
   })
